...
public class Arff {
    ...
    * 将未进行标记的转化为基于arff标记的
    *
    * @param sLabelledTextFile    标签文本文件
    * @param iClassType           类类型
    * @param iNGrams
    * @param iMinFeatureFrequency 最小特征频率
    * @param iMaxFeatures         最大特点
    * @param sUnlabelledTextFile  未标记文本文件
    * @return {@link String[]}
    */
    ...
    * 将情绪类文本转成arff文件
    *
    * @param sSentiTextFileIn     情绪文本文件
    * @param sArffFileOut         arff文件
    * @param bHeaderLine
    * @param textParsingOptions   文本分析选项
    * @param classOptions         类选择
    * @param resources            资源
    * @param iSentimentType       情绪类型
    * @param iMinFeatureFrequency 最小特征频率
    * @param arffStringIndex      字符索引
    * @return boolean
    */
    ...
    * 合并标记和未标记文本文件
    *
    * @param sLabelledTextFileIn   标记的文本文件
    * @param sUnlabelledTextFileIn 未标记文本文件中
    * @param sTextFileOut          文件输出
    */
    ...
    *
    * @param sWord                               情绪词
    * @param bCodeNumbersForQuestionMarksNotUsed b
    * @return {@link String}
    */
    ...
    * 从文本文件建立索引
    *
    * @param sSentiTextFileIn   输入情绪类文本
    * @param bHeaderLine        标题
    * @param textParsingOptions 文本分析选项
    * @param classOptions       类选择
    * @param resources          资源
    * @param iSentimentType     情绪类型
    ...
    * 从arff建立索引
    *
    * @param sArffFileIn arff文件输入
    * @return {@link StringIndex}
    */
    ...
    * 某个arff是否由两个合并
    *
    * @param sArffFile1      arff1
    * @param bVerbose        arff2
    * @param sMergedArffFile 合并的arff
    * @return boolean
    */
   ...
   /**
    * 将情绪类文本名加上ingram转为.arff文件
    *
    * @param sSentiTextFileIn 情绪类文本
    * @param iNgram
    * @return {@link String}
    */
    ...
    * 一个ngram文件名pos底片
    *
    * @param sSentiTextFileIn 情绪类文本文件
    * @param iNgram           ngram
    * @param bPos             
    * @return {@link String}
    */
    ...
    *
    * @param sSentiTextFileIn                  情绪类文本文件
    * @param bHeaderLine                       标题行
    * @param textParsingOptions                文本分析选项
    * @param classOptions                      类选择
    * @param resources                         资源
    * @param iSentimentType                    情绪类型
    * @param iMinFeatureFrequency              最小特征频率
    * @param sArffFileForPermittedFeaturesList arff文件允许功能列表
    * @return {@link String[]}
    */
    ...
    * 从arff文件里删除列
    *
    * @param sArffFile    arff文件
    * @param iColToRemove 删除行
    * @param sNewArffFile 新arff文件
    * @return boolean
    */
    ...
    * 是否打印选择的特征
    *
    * @param sAttributes      属性
    * @param iAttributesCount 属性数
    * @param bDelete          删除
    * @param swNew            
    * @param bVerbose         
    * @return boolean
    ...
    *
    * @param srArff                 
    * @param bDeleteCol             删除行
    * @param iAttributeCount        属性数
    * @param swOutput               输出
    * @param bPrintDeletedColsAtEnd
    * @param bVerbose
    * @return boolean
    */
    ...
    * 不重复地打印数据
    *
    * @param rArff1            r arff1
    * @param rArff2            r arff2
    * @param bDuplicate2       b duplicate2
    * @param iAttributes1Count attributes1数量
    * @param iAttributes2Count attributes2数量
    * @param wMerged           合并
    */
    ...
    * 打印非重复属性
    *
    * @param sAttributes1      attributes1
    * @param iAttributes1Count attributes1数
    * @param sAttributes2      attributes2
    * @param iAttributes2Count attributes2数
    * @param bVerbose
    * @param wMerged
    * @return {@link boolean[]}
    */
    ...
    * @param iDataCount      数据数
    * @param iClass          类
    * @param iFirstClass     第一个类
    * @param iLastClass      最后一个类
    * @return double
    */
