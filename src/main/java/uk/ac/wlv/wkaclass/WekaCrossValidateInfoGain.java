...
public class WekaCrossValidateInfoGain
{
    ...
    /**
     *本函数对分类器进行测试，输出分类结果和实验统计数据。
     * @param args 参数 args 表示命令行参数。
     * @param minFeatures 参数 minFeatures表示特征数范围和步长。
     * @param maxFeatures 参数 maxFeatures表示特征数范围和步长。
     * @param stepFeatures 参数 stepFeatures 表示特征数范围和步长。
     * @param iterations 表示测试迭代次数。
     * @param classifierName 表示用于测试的分类器名称。
     * @param classifierExclude 表示不参与测试的分类器名称（可以为空）。
     * @param addToClasspath 表示要添加到classpath的路径。
     * @param instructionFilename 表示读取特征选择指令的文件路径和名称。
     * @param inputFilename 表示读取待测试数据的文件路径和名称。
     * @param resultsFileName 表示输出分类结果的文件路径和名称。
     * @param summaryResultsFileName 表示输出实验统计数据的文件路径和名称。
     */
    ...
    /**
     * 本函数用于打印分类结果
     * @param eval 参数 eval 表示评估器对象。
     * @param arffFilename 参数 arffFilename 表示测试数据文件名。
     * @param classifierName 参数 classifierName 表示分类器名称。
     * @param randomSeed 参数 randomSeed 表示随机种子。
     * @param features 参数 features 表示特征数。
     * @param options 参数 options 表示分类器选项。
     * @param allResultsFilename 参数 allResultsFilename 表示输出所有结果的文件路径和名称。
