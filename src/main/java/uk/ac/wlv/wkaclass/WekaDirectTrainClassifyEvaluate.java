...
public class WekaDirectTrainClassifyEvaluate
{
    ...
    /**
     * 将训练集和测试集的所有实例直接用分类器进行分类，并将结果写入文件。
     * @param arffTrainFile 参数 arffTrainFile 表示训练集文件名。
     * @param arffEvalFile 参数 arffEvalFile 表示测试集文件名。
     * @param classifierName 参数 classifierName 表示分类器名称。
     * @param classifierExclude 参数 classifierExclude 表示需要排除的分类器。
