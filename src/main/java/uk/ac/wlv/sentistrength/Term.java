...
/**
 * 术语类，包括Word/Punctuation/Emoticon等
 * related UC: UC-1,UC-3,UC-4,UC-5,UC-7,UC-21,UC-27
 */
...
public class Term {
   ...
   /**
    * 提取单词/标点符号/表情符号
    * @param sWordAndPunctuation 单词和标点符号
   ...
   /**
    * 用通配符匹配字符串
    * @param sTextWithWildcard 带有通配符的文本
    * @param bConvertToLowerCase 是否转换为小写
    * @return boolean
    */
   ...
   /**
    * 编码表情符号
    * @param sPossibleEmoticon 可能存在的表情符号
    * @return boolean
    */
