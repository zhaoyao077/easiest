...
/**
 * 语句类
 * related UC: UC-1,UC-4,UC-5,UC-7,UC-8,UC-9,UC-10,UC-21,UC-27
 */
...
public class Sentence {
    ...
    /**
     * 将当前语句加入索引列表
     * @param unusedTermClassificationIndex 未使用术语类索引
     */
    ...
    /**
     * 用对象评论强度覆写术语强度
     * @param recalculateIfAlreadyDone 如果已完成则重新计算
     */
